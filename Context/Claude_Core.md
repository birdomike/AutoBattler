...
│   │   │   │   ├── ActionIndicator.js     # Displays ability text above characters
...
│   │   │   │   ├── StatusEffectContainer.js # Contains status effect icons
│   │   │   │   ├── StatusEffectTooltip.js # Tooltip for status effects
...
- **Battle UI includes**:
  - Card-based character representations with type-specific frames and colors
...
### Card Frame System
- **Card-based Character Representation**:
  - Replaced transparent PNG images with styled card frames
  - Cards show character art with type-specific frame colors and visual effects
  - Implemented in `js/phaser/components/ui/CardFrame.js`
- **Visual Features**:
  - Type-specific color themes for frames that match character's elemental type
  - Visual depth effects including inner glow and edge highlights/shadows
  - Nameplate at bottom of card displaying character name
  - Health bar repositioned to top of card for better artwork visibility
  - Health text displayed on health bar with improved rendering order
- **Layout Optimizations**:
  - Vertical team spacing adjusted to prevent card overlap (350px spacing)
  - Horizontal team positioning optimized (player team at x=600, enemy team at x=1400)
  - Battle controls repositioned and resized for better layout harmony
  - Streamlined top banner UI elements to focus attention on gameplay
- **Technical Implementation**:
  - Modularity: Card frame is a reusable component across the game
  - Defensive programming with comprehensive error handling
  - Configurable properties for easy customization
  - Optimized rendering with proper layer ordering
  - Accessible via CharacterSprite's cardConfig property
...
- **Refactoring Progress**: 
 ...
 - **BattleScene Refactoring**: Completed
  ...
  - Phase 4 Complete: Extracted `BattleAssetLoader` for asset loading management
  - Phase 5 Complete: Implemented `BattleFXManager` for visual effects
  - Phase 6 Complete: Consolidated debug tools with `PhaserDebugManager`
  - Phase 7 Complete: Final cleanup and documentation
 - **Card Frame Implementation**: Complete
  - Added card-based representation for characters replacing transparent PNG images
  - Implemented type-specific colors, frames, visual depth effects
  - Optimized health bar and nameplate positioning
  - Improved spacing and layout for better visibility
...
- Previous DOM-based Battle UI has been replaced with a Phaser-based implementation
